...
def analyzePcap(filepath):
    ...
    print('vnc_feature_count=' + str(vnc_feature_count))    
...
get_filelist(u'C:\\Users\\dong\\Desktop\\workAtHome\\dridex\\dridexPcap')

print('vnc_file_count=' + str(vnc_file_count))